...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (auth.getCurrentUser() != null) {
            ...
            textEmail = (TextInputEditText) findViewById(R.id.email_edit_login);
            textPassword = (TextInputEditText) findViewById(R.id.password_edit_login);
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    Toast.makeText(getApplicationContext(), "Email sent. Please check your email", Toast.LENGTH_SHORT);
