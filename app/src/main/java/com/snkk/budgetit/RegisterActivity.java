...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textEmail = (TextInputEditText)findViewById(R.id.email_edit_register);
        textPassword = (TextInputEditText)findViewById(R.id.password_edit_register);
        progressBar = (ProgressBar)findViewById(R.id.progressBarRegister);
        textName = (TextInputEditText)findViewById(R.id.name_edit_register);
